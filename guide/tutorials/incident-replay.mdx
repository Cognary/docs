...
- 📖 15 minutes
- ⚙️ A failed run observed in logs., Access to `run_id` or `decision_id` and tenant/scope.
- 🎯 You can rebuild the execution chain and produce replay evidence for incident review.
